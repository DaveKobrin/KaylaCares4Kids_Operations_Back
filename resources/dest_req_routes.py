...
bp_name = 'api-dest-req-routes'
bp_url_prefix = '/api/v1/dest-req'
...
def dest_req_index():
    ...
    result = (models.DestRequest.select()
            .order_by(models.DestRequest.is_filled, models.DestRequest.date_req)
            )
